...
function getConnection() {
	...
	global $db_MassPageCreator_db_Url, $db_MassPageCreator_db_User, $db_MassPageCreator_db_Pass, $db_MassPageCreator_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_MassPageCreator_db_Url.";dbname=".$db_MassPageCreator_db_DbName, $db_MassPageCreator_db_User, $db_MassPageCreator_db_Pass);
